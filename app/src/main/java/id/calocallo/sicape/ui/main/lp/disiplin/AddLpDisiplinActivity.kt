...
//            .setMessage("Masukkan Data Sipil")
            .setPositiveButton("Tambah") { _, _ ->
                ...
                txt_ttl_sipil_disiplin_lp_add.text = "TTL : ${tmptSipil}, ${formatterTanggal(tglSipil)}"
                ...
                txt_kwg_sipil_disiplin_lp_add.text = "Kewarganegaraan : ${kwgSipilView.text.toString()}"

                alamatSipil = alamatSipilView.text.toString()
                txt_alamat_sipil_disiplin_lp_add.text = "Alamat : ${alamatSipilView.text.toString()}"

                notelpSipil = noTelpSipilView.text.toString()
                txt_no_telp_sipil_disiplin_lp_add.text = "No Telp : ${noTelpSipilView.text.toString()}"
